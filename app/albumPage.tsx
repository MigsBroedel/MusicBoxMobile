...
const AlbumDetailScreen: React.FC = () => {
  ...
  const fetchReviews = async () => {
      try {
        const response = await fetch(`https://musicboxdback.onrender.com/review/album/${id}`);
  ...
  const handleFavoritePress = async () => {
    ...
    try {
      ...
      const response = await axios.patch(`https://musicboxdback.onrender.com/users/${userId}`, {
