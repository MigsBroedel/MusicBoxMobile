...
const API_BASE_URL = 'https://musicboxdback.onrender.com'; // Substitua pelo seu host real
...
const SearchUsersScreen: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      setIsLoading(true);
      try {
        const res = await fetch(`https://musicboxdback.onrender.com/users?name=${encodeURIComponent(searchQuery)}`);
